...
<!-- generated with COPASI 4.44 (Build 295) (http://www.copasi.org) at 2025-06-10T20:39:57Z -->
...
<rdf:Description rdf:about="#Reaction_4">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4677" name="k1" value="9.31566e-05"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Actin_Polyermization,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#Reaction_5">
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_6924" name="k2" value="9.44652"/>
        </ListOfConstants>
        <KineticLaw function="Function_14" unitType="Default" scalingCompartment="CN=Root,Model=Actin_Polyermization,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_69">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Values[SPIN90 Kd]" value="6.9553350306681154e-06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Values[kon]" value="1358168.5802837" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[SPIN90-Arp2/3 (nucleation)]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[SPIN90-Arp2/3 (nucleation)],ParameterGroup=Parameters,Parameter=k1" value="9.3156644452575777e-05" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[SPIN90 binding Arp2/3]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[SPIN90 binding Arp2/3],ParameterGroup=Parameters,Parameter=k1" value="1358168.5802837" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Actin_Polyermization,Vector=Values[kon],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[SPIN90 binding Arp2/3],ParameterGroup=Parameters,Parameter=k2" value="9.4465175039999991" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 1806642228000000 0 0 0 0 0 0 301107038000000 15055351900000 0 0 0 0 1358168.5802837 1 6.9553350306681154e-06 
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="9.4465175039999991"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="9.3156644452575777e-05"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="6.9553350306681154e-06"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
