...
<!-- generated with COPASI 4.44 (Build 295) (http://www.copasi.org) at 2025-02-18T23:16:14Z -->
...
<rdf:Description rdf:about="#Metabolite_4">
      ...
      <Metabolite key="Metabolite_5" name="F_actin_PE" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelValue_0">
        ...
        <Comment>
          transient concentration assignment
        </Comment>
        <Expression>
          &lt;CN=Root,Model=Actin_Polyermization,Vector=Compartments[compartment],Vector=Metabolites[F_actin_BE],Reference=Concentration>+&lt;CN=Root,Model=Actin_Polyermization,Vector=Compartments[compartment],Vector=Metabolites[F_actin_PE],Reference=Concentration>
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
...
<rdf:Description rdf:about="#Reaction_3">
      ...
      <Reaction key="Reaction_4" name="Pointed End Elongation" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_4">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4677" name="kon" value="1.3e+06"/>
          <Constant key="Parameter_6923" name="koff" value="0.8"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Actin_Polyermization,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Dimerization]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Dimerization],ParameterGroup=Parameters,Parameter=k1" value="0.077767042209999998" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Dimerization],ParameterGroup=Parameters,Parameter=k2" value="0.6631231155037528" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimerization]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimerization],ParameterGroup=Parameters,Parameter=k1" value="125332.24800677023" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimerization],ParameterGroup=Parameters,Parameter=k2" value="251.23669460559964" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimer Nucleation]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimer Nucleation],ParameterGroup=Parameters,Parameter=k1" value="1423510896.7775915" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 1204428152000000 0 0 0 0 0 0 1 
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Dimerization],ParameterGroup=Parameters,Parameter=k1,Reference=Value"/>
            <Parameter name="LowerBound" type="cn" value="1e-06"/>
            <Parameter name="UpperBound" type="cn" value="1e+04"/>
            <Parameter name="StartValue" type="float" value="0.077767042209999998"/>
          ...
          <ParameterGroup name="FitItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Dimerization],ParameterGroup=Parameters,Parameter=k2,Reference=Value"/>
            <Parameter name="LowerBound" type="cn" value="1e-06"/>
            <Parameter name="UpperBound" type="cn" value="100"/>
            <Parameter name="StartValue" type="float" value="0.6631231155037528"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          ...
          <ParameterGroup name="FitItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimerization],ParameterGroup=Parameters,Parameter=k1,Reference=Value"/>
            <Parameter name="LowerBound" type="cn" value="1e-04"/>
            <Parameter name="UpperBound" type="cn" value="1e6"/>
            <Parameter name="StartValue" type="float" value="125332.24800677023"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          ...
          <ParameterGroup name="FitItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimerization],ParameterGroup=Parameters,Parameter=k2,Reference=Value"/>
            <Parameter name="LowerBound" type="cn" value="1e-03"/>
            <Parameter name="UpperBound" type="cn" value="1e+03"/>
            <Parameter name="StartValue" type="float" value="251.23669460559964"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="1423510896.7775915"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="Experiment">
            ...
            <Parameter name="File Name" type="file" value="../data/Actin_2_monomers.txt"/>
            <Parameter name="First Row" type="unsignedInteger" value="1"/>
            <Parameter name="Last Row" type="unsignedInteger" value="451"/>
          ...
          <ParameterGroup name="Experiment_1">
            ...
            <Parameter name="File Name" type="file" value="../data/Actin_3_monomers.txt"/>
            <Parameter name="First Row" type="unsignedInteger" value="1"/>
            <Parameter name="Last Row" type="unsignedInteger" value="332"/>
            <Parameter name="Experiment Type" type="unsignedInteger" value="1"/>
            <Parameter name="Normalize Weights per Experiment" type="bool" value="1"/>
            <Parameter name="Separator" type="string" value="&#x09;"/>
            <Parameter name="Weight Method" type="unsignedInteger" value="1"/>
          ...
          <ParameterGroup name="Experiment_2">
            ...
            <Parameter name="File Name" type="file" value="../data/Actin_4_monomers.txt"/>
            <Parameter name="First Row" type="unsignedInteger" value="1"/>
            <Parameter name="Last Row" type="unsignedInteger" value="308"/>
            <Parameter name="Experiment Type" type="unsignedInteger" value="1"/>
            <Parameter name="Normalize Weights per Experiment" type="bool" value="1"/>
            <Parameter name="Separator" type="string" value="&#x09;"/>
            <Parameter name="Weight Method" type="unsignedInteger" value="1"/>
          ...
          <ParameterGroup name="Experiment_3">
            ...
            <Parameter name="File Name" type="file" value="../data/Actin_5_monomers.txt"/>
            <Parameter name="First Row" type="unsignedInteger" value="1"/>
            <Parameter name="Last Row" type="unsignedInteger" value="286"/>
            <Parameter name="Experiment Type" type="unsignedInteger" value="1"/>
            <Parameter name="Normalize Weights per Experiment" type="bool" value="1"/>
            <Parameter name="Separator" type="string" value="&#x09;"/>
            <Parameter name="Weight Method" type="unsignedInteger" value="1"/>
  ...
  <ListOfPlots>
    <PlotSpecification name="Parameter Estimation Result" type="Plot2D" active="1" taskTypes="Scan, Parameter Estimation">
      ...
      <ListOfPlotItems>
        <PlotItem name="Experiment,Values[F-actin](Measured Value)" type="Curve2D">
        ...
        <PlotItem name="Experiment,Values[F-actin](Fitted Value)" type="Curve2D">
        ...
        <PlotItem name="Experiment,[Monomer](Measured Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="3"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="1"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="1"/>
        ...
        <PlotItem name="Experiment,[Monomer](Fitted Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
        ...
        <PlotItem name="Experiment_1,Values[F-actin](Measured Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="3"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="1"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="1"/>
        ...
        <PlotItem name="Experiment_1,Values[F-actin](Fitted Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
        ...
        <PlotItem name="Experiment_1,[Monomer](Measured Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="3"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="1"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="1"/>
        ...
        <PlotItem name="Experiment_1,[Monomer](Fitted Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
        ...
        <PlotItem name="Experiment_2,Values[F-actin](Measured Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="3"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="1"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="1"/>
        ...
        <PlotItem name="Experiment_2,Values[F-actin](Fitted Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
        ...
        <PlotItem name="Experiment_2,[Monomer](Measured Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="3"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="1"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="1"/>
        ...
        <PlotItem name="Experiment_2,[Monomer](Fitted Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
        ...
        <PlotItem name="Experiment_3,Values[F-actin](Measured Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="3"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="1"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="1"/>
        ...
        <PlotItem name="Experiment_3,Values[F-actin](Fitted Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
        ...
        <PlotItem name="Experiment_3,[Monomer](Measured Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="3"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="1"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="1"/>
        ...
        <PlotItem name="Experiment_3,[Monomer](Fitted Value)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
