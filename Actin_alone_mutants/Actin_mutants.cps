...
<!-- generated with COPASI 4.44 (Build 295) (http://www.copasi.org) at 2025-06-10T17:25:00Z -->
...
<rdf:Description rdf:about="#Reaction_2">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4679" name="k1" value="1.15117e+06"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Dimerization]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Dimerization],ParameterGroup=Parameters,Parameter=k1" value="3.4027303029995686" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Dimerization],ParameterGroup=Parameters,Parameter=k2" value="0.074572802833823379" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimerization]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimerization],ParameterGroup=Parameters,Parameter=k1" value="1201.9320583153146" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimerization],ParameterGroup=Parameters,Parameter=k2" value="13.170691605008971" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimer Nucleation]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Actin_Polyermization,Vector=Reactions[Actin Trimer Nucleation],ParameterGroup=Parameters,Parameter=k1" value="1151168.8359208624" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="3.4027303029999998"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="0.074572802833823379"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="1201.9320583153146"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="13.170691605008971"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="1151168.8359208624"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
        ...
        <ParameterGroup name="Experiment Set">
          ...
          <ParameterGroup name="Experiment_1">
            ...
            <Parameter name="File Name" type="file" value="data/Actin_3_monomers_2.txt"/>
            <Parameter name="First Row" type="unsignedInteger" value="1"/>
            <Parameter name="Last Row" type="unsignedInteger" value="466"/>
            <Parameter name="Experiment Type" type="unsignedInteger" value="1"/>
            <Parameter name="Normalize Weights per Experiment" type="bool" value="1"/>
            <Parameter name="Separator" type="string" value="&#x09;"/>
            <Parameter name="Weight Method" type="unsignedInteger" value="1"/>
          ...
          <ParameterGroup name="Experiment_2">
            ...
            <Parameter name="First Row" type="unsignedInteger" value="1"/>
            <Parameter name="Last Row" type="unsignedInteger" value="269"/>
            <Parameter name="Experiment Type" type="unsignedInteger" value="1"/>
            <Parameter name="Normalize Weights per Experiment" type="bool" value="1"/>
            <Parameter name="Separator" type="string" value="&#x09;"/>
            <Parameter name="Weight Method" type="unsignedInteger" value="1"/>
          ...
          <ParameterGroup name="Experiment_3">
            ...
            <Parameter name="First Row" type="unsignedInteger" value="1"/>
            <Parameter name="Last Row" type="unsignedInteger" value="199"/>
            <Parameter name="Experiment Type" type="unsignedInteger" value="1"/>
            <Parameter name="Normalize Weights per Experiment" type="bool" value="1"/>
            <Parameter name="Separator" type="string" value="&#x09;"/>
            <Parameter name="Weight Method" type="unsignedInteger" value="1"/>
          ...
          <ParameterGroup name="Experiment_4">
            ...
            <Parameter name="File Name" type="file" value="data/Actin_6_monomers.txt"/>
            <Parameter name="First Row" type="unsignedInteger" value="1"/>
            <Parameter name="Last Row" type="unsignedInteger" value="142"/>
            <Parameter name="Experiment Type" type="unsignedInteger" value="1"/>
            <Parameter name="Normalize Weights per Experiment" type="bool" value="1"/>
            <Parameter name="Separator" type="string" value="&#x09;"/>
            <Parameter name="Weight Method" type="unsignedInteger" value="1"/>
          ...
          <ParameterGroup name="Experiment_5">
            ...
            <Parameter name="File Name" type="file" value="data/Actin_7_monomers.txt"/>
            <Parameter name="First Row" type="unsignedInteger" value="1"/>
            <Parameter name="Last Row" type="unsignedInteger" value="122"/>
            <Parameter name="Experiment Type" type="unsignedInteger" value="1"/>
            <Parameter name="Normalize Weights per Experiment" type="bool" value="1"/>
            <Parameter name="Separator" type="string" value="&#x09;"/>
            <Parameter name="Weight Method" type="unsignedInteger" value="1"/>
